(function() {
  ...
  */
  ...
  module.exports = client = function(settings) {
    var c, _buildMatchingUri, _buildUri, _handleRequestResult, _invokeMatchingRequest, _invokeRequest, _normalizeQueryString;
    if (settings == null) {
      settings = {};
    }
    _.defaults(settings, {
    ...
    */
    ...
    _buildMatchingUri = function(path, queryString) {
      if (queryString == null) {
        queryString = {};
      }
      return "" + settings.matchingUri + path + "?" + (qs.stringify(queryString));
    };
    _invokeMatchingRequest = function(path, body, cb) {
    ...
    c = {
      ...
      locationMatch: function(matchData, cb) {
        if (matchData == null) {
          matchData = {};
        }
        ...
        return _invokeMatchingRequest("/location-match", matchData, cb);
      },
      locations: {
        /*
